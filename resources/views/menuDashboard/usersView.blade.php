                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="nombre_form" placeholder="Nombre..."
                                    name="nombre_form">
                            </div>

                            <div class="form-group">
                                <label for="apellido_form">Apellido:</label>
                                <input type="text" class="form-control" id="apellido_form" placeholder="Apellido..."
                                    name="apellido_form">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre_emergencia_form"
                                    placeholder="Nombre contacto" name="nombre_emergencia_form">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="my_numero"
                                    placeholder="Número de contacto..." name="my_numero">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="direccion_form"
                                    placeholder="Dirección..." name="direccion_form">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email_form"
                                    placeholder="pepitoperez@example.com" name="email_form">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {{-- <select class="form-control select2 select2-danger"
                                    ...
                                    name="select_labor_edit" id="select_labor_edit">
                                    <option selected="selected">Seleccionar labor</option>

                                    @foreach ($labores as $labor)
                                        <option value="{{ $labor['id_labor'] }}">{{ $labor['nombre_labor'] }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="form_num_emergencia"
