...
<div class="card card-primary card-tabs" style="width: 100%">
    <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            ...
            @if ($permisos === 'contability')
                ...
                <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill" href="#tab_egress"
                        role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false"><i
                            class="fa-solid fa-magnifying-glass"></i>&nbsp;&nbsp;Egresos Detallados</a>
                </li>
            @endif
            <li class="nav-item">
    ...
    <div class="card-body">
        <div class="tab-content" id="custom-tabs-one-tabContent">
            ...
            <div class="tab-pane fade" id="tab_egress" role="tabpanel" aria-labelledby="tab_egress">
                        ...
                        <tbody>
                            @foreach ($egress_detail as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ $item['url_imagen'] }}" type="button" target="_blank"><i
                                                style="font-size: 25px" class="fa-solid fa-file-image"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
